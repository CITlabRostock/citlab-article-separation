...
class SeparatorRegionToPageWriter(RegionToPageWriter):
    ...
    def remove_separator_regions_from_page(self):
        self.remove_region_by_type(sSEPARATORREGION)
    ...
    def merge_regions(self, remove_holes=True):
        ...
        def _split_text_lines(text_region_list, sep_poly):
            """
            ...
            updated_text_region_list = deepcopy(text_region_list)
            for j, text_region in enumerate(text_region_list):
                text_line_list = text_region.text_lines
                ...
                updated_text_region_list[j].text_lines = updated_text_line_list
                # self.page_object.set_text_lines(text_region, updated_text_line_list)
                # region_dict[region_type] = updated_region_list
            return updated_text_region_list, True
        ...
        for separator_polygon in separator_polygons:
            ...
            text_regions, use_separator = _split_text_lines(text_regions, separator_polygon)
        ...
        for text_region in text_regions:
            self.page_object.add_region(text_region)
